  ...
  try {
    ...
    if (isRecurring) {
      ...
      const { data: payment } = await supabase
        ...
        .insert({
          ...
          invoice_url: firstAsaasPayment?.invoiceUrl || subJson.invoiceUrl || null,
          bank_slip_url: firstAsaasPayment?.bankSlipUrl || subJson.bankSlipUrl || null,
          payment_method: billingType,
          is_recurring: true,
          interval_days: intervalDays,
          external_provider: "asaas",
    ...
    await supabase
      ...
      .update({
        ...
        bank_slip_url: payJson.bankSlipUrl || null,
        payment_method: billingType,
        is_recurring: false,
        interval_days: null,
      })
